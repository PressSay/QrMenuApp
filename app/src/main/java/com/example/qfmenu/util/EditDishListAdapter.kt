...
class EditDishListAdapter (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val adapter = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_edit_category_or_dish, parent, false)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.btnConfig.setOnClickListener {
            ...
            holder.view.findNavController()
                .navigate(R.id.action_editCreateDishFragment_to_editCreateDetailDishFragment)
        }
